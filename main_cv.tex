...
\name{\color{navyblue}Diana W. Dawoud}

\begin{document}

\printPersonalInfo{
  \personalInfo{\info{Assistant Professor, MIEEE, }}
  \personalInfo{\info{College Of Engineering \& IT,University of Dubai}}
  \personalInfo{\info{\faIcon{envelope}: dawoud@ieee.org} \infoSeparator\info{\faPhoneSquare* : +971-050-474-6977}\infoSeparator\info{\href{https://linkedin.com/in/dianadawoud}{\faIcon{linkedin}}: dianadawoud}   }
}
